...
public class Utils {
    ...
    public static RoomDTO mapRoomEntityToRoomDTOPlusUserBookings(Room room){
        RoomDTO roomDTO= new RoomDTO();
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user){
        ...
        if (!user.getBookings().isEmpty()){
            userDTO.setBookings(user.getBookings().stream().collect(Collectors.toList()));

        }
        return userDTO;
    }

    public static BookingDTO mapBookingEntityToUserDTOPlusUserBookingsAndRoom(Booking booking,boolean mapUser){
        BookingDTO bookingDTO= new BookingDTO();
        ...
        if (booking.getRoom() != null){
            ...
            roomDTO.setRoomDescription(booking.getRoom().getRooDescription());
        }
        return bookingDTO;
    }
